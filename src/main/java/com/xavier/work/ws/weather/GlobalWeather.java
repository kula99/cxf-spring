...
public class GlobalWeather extends Service {
    ...
    static {
        ...
        try {
            ...
            Logger.getLogger(GlobalWeather.class.getName())
                .log(Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://www.webservicex.net/globalweather.asmx?wsdl");
        }*/
      URL url = GlobalWeather.class.getClassLoader().getResource("classpath:xsd/globalweather.wsdl");
        WSDL_LOCATION = url;
    }
